## Solution with async/await examples
You could find constructions and examples from next video 
https://youtu.be/FjIIbG9abM8 
...
## Configure session to use ilspycmd
```
zsh -l
export PATH="$PATH:/Users/andrejpoluhovic/.dotnet/tools"
```

## Decompile the assembly
```
 ilspycmd  "AsyncStateMachine/bin/Debug/netcoreapp3.1/AsyncStateMachine.dll" -o "AsyncStateMachine/bin/Debug/netcoreapp3.1/Decompiled" -r "AsyncStateMachine/bin/Debug/netcoreapp3.1" -il -genpdb
```
